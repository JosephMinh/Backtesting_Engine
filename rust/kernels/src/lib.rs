...
//!
//! This crate is the only Rust workspace member that defines canonical kernel
//! artifact references. Later operational crates consume these types instead of
//! redefining their own path or artifact vocabulary.
...
mod tests {
    use super::{
        APPROVED_ARTIFACT_ROOTS, ApprovedArtifactRef, ArtifactBoundaryError, KERNEL_BOUNDARY,
    };
